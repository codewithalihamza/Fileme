...
import { ArrowLeft, Calendar, CheckCircle, Clock, DollarSign, Edit, FileText, Save, User, X, XCircle } from "lucide-react";
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mt-1">View and manage request information</p>
                        </div>
                    </div>
                    ...
                    <CardContent className="space-y-4">
                        <div>
                            ...
                            {editing ? (
                                ...
                                <p className="text-gray-900">{getServiceLabel(request.service)}</p>
                            )}
                        </div>
                        ...
                        <div>
                            ...
                            {editing ? (
                                <Input
                                    ...
                                    onChange={(e) => setEditData({ ...editData, paidAmount: e.target.value ? parseFloat(e.target.value) : null })}
                                />
                            ) : (
                                <div className="flex items-center gap-2">
                ...
                <Card>
                    ...
                    <CardContent className="space-y-4">
                        ...
                        <div>
                            ...
                            {editing ? (
                                <Select
                                    value={editData.assigneeId || request.assigneeId || "unassigned"}
                                    onValueChange={(value) => setEditData({ ...editData, assigneeId: value === "unassigned" ? null : value })}
                                >
                                    <SelectTrigger>
